(function(){
  ...
  function renderHeader(){
    ...
    target.innerHTML=`
      ...
      <header class="header">
        <nav class="nav">
          <a class="brand brand-logo image-only" href="index.html" aria-label="Suyu Street">
            <img src="assets/img/logo-suyu-street.png" alt="Suyu Street">
          </a>
          <div class="navlinks">${navLinks}</div>
          <div class="spacer"></div>
          <select id="currency" class="field currency-select" aria-label="Seleccionar moneda"><option>USD</option><option>PEN</option><option>CLP</option><option>ARS</option><option>COP</option><option>MXN</option><option>BRL</option><option>UYU</option><option>EUR</option></select>
      ...
      <footer class="footer">
        <div class="footer-inner">
          <div class="footer-brand">
            <img src="assets/img/logo-suyu-street-white.png" alt="Suyu Street" class="footer-logo">
            <p>Streetwear con identidad. Diseños urbanos, piezas limitadas y envíos internacionales.</p>
            <div class="footer-contact"><a href="mailto:contacto@suyustreetwear.com">contacto@suyustreetwear.com</a><a href="https://wa.me/51900000000" target="_blank" rel="noopener">WhatsApp: +51 900 000 000</a></div>
          </div>
          <div class="footer-col"><h3>Comprar</h3><a href="catalogo.html?cat=Mujer">Mujer</a><a href="catalogo.html?cat=Hombre">Hombre</a><a href="catalogo.html?cat=Unisex">Unisex</a><a href="catalogo.html?cat=Zapatillas">Zapatillas</a><a href="catalogo.html?cat=Colecciones">Colecciones</a></div>
          <div class="footer-col"><h3>Ayuda y políticas</h3><a href="#">Cambios y devoluciones</a><a href="#">Envíos internacionales</a><a href="#">Política de compras</a><a href="#">Términos de uso</a><a href="#">Política de privacidad</a><a href="#">Cookies</a><a href="#">Libro de reclamaciones</a></div>
          <div class="footer-col"><h3>Empresa</h3><a href="#">Sobre Suyu</a><a href="#">Proveedores</a><a href="#">Plan de sostenibilidad</a><a href="#">Colaboraciones</a><a href="#">Prensa</a></div>
        </div>
        <div class="footer-bottom"><span>© ${new Date().getFullYear()} Suyu Street. Todos los derechos reservados.</span><span>PayPal · Mercado Pago · Envíos internacionales</span></div>
      </footer>`;
  }
